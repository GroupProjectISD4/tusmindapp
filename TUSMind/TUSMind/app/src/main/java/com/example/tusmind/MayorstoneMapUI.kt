...
@Composable
fun MayorstoneMapUI(navController: NavHostController) {
    Box(
        modifier = Modifier
            .fillMaxSize()
    ) {
        ...
        Column(
            ...
            // Map Image
            Image(
                painter = painterResource(id = R.drawable.mayorstonepark), // Replace with Mayorstone map image
                contentDescription = "Mayorstone Quarry Park Map",
            ...
            Column(
                ...
                Text(
                    text = "End point: Mayorstone Quarry Park",
                    style = TextStyle(
                        fontSize = 18.sp,
                        fontWeight = FontWeight.Normal,
                        color = Color.White
